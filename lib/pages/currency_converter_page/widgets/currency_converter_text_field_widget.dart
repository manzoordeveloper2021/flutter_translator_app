...
class CurrencyConverterTextFieldWidget extends StatelessWidget {
  @override
          ...
          child: Consumer<CurrencyConverterProvider>(
            builder: (context,currencyProvider,child) {
              return Padding(
                ...
                child:
                TextFormField(
                  // controller: Provider.of<CurrencyConverterProvider>(context,listen: false).textEditingController,
                  minLines: 5,
                  maxLines: 15,
                  onFieldSubmitted: (String value) {
                    currencyProvider.setPreDefineAmount(value);
                  },
